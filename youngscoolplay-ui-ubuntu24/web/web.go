// Package web provides the main web server implementation for the 3YOUNGSCOOLPLAY-UI panel,
...
import (
	...
	"github.com/victoralwaysyoung/youngscoolplay-ui/web/controller"
	"github.com/victoralwaysyoung/youngscoolplay-ui/web/job"
...
// Server represents the main web server for the 3YOUNGSCOOLPLAY-UI panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("youngscoolplay-ui", store))
