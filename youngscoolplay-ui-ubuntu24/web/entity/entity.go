// Package entity defines data structures and entities used by the web layer of the 3YOUNGSCOOLPLAY-UI panel.
package entity
...
// AllSetting contains all configuration settings for the 3YOUNGSCOOLPLAY-UI panel including web server, Telegram bot, and subscription settings.
