...
import (
	...
	"github.com/mhsanaei/3youngscoolplay-ui/v2/web/controller"
	"github.com/mhsanaei/3youngscoolplay-ui/v2/web/job"
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("3YOUNGSCOOLPLAY-UI", store))
