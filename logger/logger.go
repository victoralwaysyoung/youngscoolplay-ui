// Package logger provides logging functionality for the 3YOUNGSCOOLPLAY-UI panel with
...
func InitLogger(level logging.Level) {
	newLogger := logging.MustGetLogger("YOUNGSCOOLPLAY-UI")
	var err error
	...
	backendLeveled.SetLevel(level, "YOUNGSCOOLPLAY-UI")
