// Package model defines the database models and data structures used by the 3YOUNGSCOOLPLAY-UI panel.
package model
...
// User represents a user account in the 3YOUNGSCOOLPLAY-UI panel.
type User struct {
...
// Setting stores key-value configuration settings for the 3YOUNGSCOOLPLAY-UI panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
