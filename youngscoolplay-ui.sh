...
install() {
    bash <(curl -Ls https://raw.githubusercontent.com/MHSanaei/3YOUNGSCOOLPLAY-UI/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update_menu() {
    ...
    wget -O /usr/bin/YOUNGSCOOLPLAY-UI https://raw.githubusercontent.com/MHSanaei/3YOUNGSCOOLPLAY-UI/main/YOUNGSCOOLPLAY-UI.sh
...
legacy_version() {
    ...
    install_command="bash <(curl -Ls "https://raw.githubusercontent.com/mhsanaei/3YOUNGSCOOLPLAY-UI/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl -Ls https://raw.githubusercontent.com/mhsanaei/3YOUNGSCOOLPLAY-UI/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    wget -O /usr/bin/YOUNGSCOOLPLAY-UI -N https://github.com/MHSanaei/3YOUNGSCOOLPLAY-UI/raw/main/YOUNGSCOOLPLAY-UI.sh
    if [[ $? != 0 ]]; then
        echo ""
