// Package main is the entry point for the 3YOUNGSCOOLPLAY-UI web panel application.
...
import (
	...
	"github.com/victoralwaysyoung/youngscoolplay-ui/sub"
	"github.com/victoralwaysyoung/youngscoolplay-ui/util/crypto"
	"github.com/victoralwaysyoung/youngscoolplay-ui/web"
...
// runWebServer initializes and starts the web server for the 3YOUNGSCOOLPLAY-UI panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the 3YOUNGSCOOLPLAY-UI panel.
func migrateDb() {
...
// main is the entry point of the 3YOUNGSCOOLPLAY-UI application.
...
func main() {
	...
	flag.Usage = func() {
		...
		fmt.Println("    migrate        migrate form other/old YOUNGSCOOLPLAY-UI")
